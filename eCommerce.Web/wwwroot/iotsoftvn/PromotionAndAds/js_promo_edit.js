...
var $borderColor = $('#ipt-border-ground');
...
$(document).ready(function () {
    ...
    ajaxGet('promotion/ById/' + promotionId, {}, function (res) {
        if (res.IsSuccess) {
            ...
            $borderColor.val(newPromotion.BorderColor);
            $iptPriority.val(newPromotion.Priority);
            if (newPromotion.StickerImage && newPromotion.IsShowSticker)
                $imgSticker.attr('src', newPromotion.StickerImage)
            $cbIsShowSticker.prop('checked', newPromotion.IsShowSticker);
...
function bindData() {
    ...
    newPromotion.BorderColor = $borderColor.val();
    newPromotion.StickerImage = $imgSticker.attr('src');
    newPromotion.IsShowSticker = $cbIsShowSticker.prop('checked');
