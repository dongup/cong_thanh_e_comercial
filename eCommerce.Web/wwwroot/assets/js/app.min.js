! function (a) {
    ...
    t.prototype._reset = function () {
        ...
        $('.navbar-nav a').each(function () {
            ...
            var e = $(this);
            if (e.attr('href') == t) { e.addClass('active'); e.closest('li').find('a.nav-link').addClass('active'); }
        })
    ...
    function (n) {
        ...
        t.prototype.initDatePicker = function () {
            ...
            n('[data-toggle="datepicker"]').datepicker({ autoclose: true, format: 'dd/mm/yyyy', language: 'vn' }).datepicker('setDate', new Date());
        }, t.prototype.initSelect2 = function () {
            n('[data-toggle="select"]').select2({ language: 'vi', width: '100%' });
            n('[data-toggle="select-no-search"]').select2({ language: 'vi', width: '100%', minimumResultsForSearch: -1 });
        }, t.prototype.initAutonumeric = function () {
            n('[data-toggle="autonumeric-money"]').autoNumeric('init', { aSep: ',', lZero: 'deny', wEmpty: 'zero', vMin: 0, aPad: false, mRound: 'A' });
            n('[data-toggle="autonumeric-number"]').autoNumeric('init', { aSep: '', lZero: 'deny', wEmpty: 'zero', vMin: 0, aPad: false, mRound: 'A' });
            n('[data-toggle="autonumeric-float"]').autoNumeric('init', { aSep: ',', lZero: 'deny', wEmpty: 'zero', vMin: 0.00, aPad: false, mRound: 'A' });
            ...
            n('[data-toggle="date-range-picker"]').each(function (t, e) {
            ...
            this.initDatePicker(), this.initSelect2(), this.initMask(), this.initDateRange(), this.initTimePicker(), this.initTouchspin(), this.initMaxlength(), this.initAutonumeric()
