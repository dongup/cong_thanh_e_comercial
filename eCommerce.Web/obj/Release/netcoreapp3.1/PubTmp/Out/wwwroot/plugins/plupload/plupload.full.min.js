 ...
 * 
 * Description param
 * element: Element click to upload
 * callback: Callback function after upload
 * url: Url API uploader
 * extensions: Licensing file ext
 * maxFileSize: Limit file size by MB
 */
function initPickFile(element, url, callback, extensions, maxFileSize = FILE_UPLOAD_MAX_SIZE) {
...
function initPickImage(element, callback) {

    let maxFileSize = 5000000;
    let extensions = 'jpg,png,gif';
    let url = ROOT_URL + "api/Upload";
...
function initPickImageWidthFolder(element,folderId, callback) {

    let maxFileSize = 5000000;
    let extensions = 'jpg,png,gif';
    let url = ROOT_URL + "api/Upload?FolderId="+folderId;
    var pluploader = new plupload.Uploader({
        runtimes: 'html5,flash,silverlight,html4',
        browse_button: element,
        unique_names: true,
