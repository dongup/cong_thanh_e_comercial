#pragma checksum "D:\eCommerce\eCommerce.Web\Areas\Admin\Views\ProductFilter\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b73e9c215d70b9224ab325061bae53d6ff72c9b7"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_ProductFilter_Index), @"mvc.1.0.view", @"/Areas/Admin/Views/ProductFilter/Index.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b73e9c215d70b9224ab325061bae53d6ff72c9b7", @"/Areas/Admin/Views/ProductFilter/Index.cshtml")]
    public class Areas_Admin_Views_ProductFilter_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\eCommerce\eCommerce.Web\Areas\Admin\Views\ProductFilter\Index.cshtml"
...
<div class=""container"">
 ...
 ");
            WriteLiteral(@"                           <div class=""tab-pane show active"" id=""tab-template"">
...
<div id=""modal-edit-filter"" class=""modal"">
    <div class=""modal-dialog"">
        <div class=""modal-content"">
          ...
          ");
            WriteLiteral(@"              <select id=""modal-edit-sl-values"" class=""select2 form-control select2-multiple"" data-toggle=""select"" multiple=""multiple"">
                        </select>
...
<div id=""modal-add-filter"" class=""modal"">
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                <h4 class=""modal-title"" id=""standard-modalLabel"">Thêm bộ");
            WriteLiteral(@" lọc </h4>
                <button type=""button"" class=""close"" data-dismiss=""modal"" aria-hidden=""true"">×</button>
            </div>
            <div class=""modal-body"">
                <div class=""form-horizontal"">
                    ...
                    <div class=""form-group"">
                        ...
                        <select id=""sl-filter-values"" class=""select2 form-control sel");
            WriteLiteral(@"ect2-multiple"" data-toggle=""select"" multiple=""multiple"">
                        </select>
    ...
    <script>
        ...
        function loadAllCategories() {
            ajaxGet('ProductCategory/GetFilter', null,
                ...
                ");
                WriteLiteral(@"                                            ${showProperty(n.PropertyFilters)}
  ...
  ");
        ...
        function showModalValueEdit(propId) {
            ajaxGet('Property/' + propId, null, function (res) {
                ...
                if (res.IsSuccess) {
                    let data = res.Result;
                    $('#modal-edit-ipt-property-n");
                WriteLiteral(@"ame').val(data.PropertyName);
            ...
            showModal('#modal-edit-filter', ""#modal-edit-btn-save-filter"", function () {
                ...
                if (values.length == 0)
                    ...
                    ajaxPut('property/setFilter/' + propId, {
                        ...
                        if (res.IsSuccess) {
                            alertif");
                WriteLiteral(@"y.success(""Cập nhật thành công"");
                            loadAllCategories();
       ...
       ");
                WriteLiteral(@"             let valueIds = $('#sl-filter-values').val();
        ...
        function AddValueProperty(element, propId) {
            ...
            showModal('#modal-add-value', '#btn-add', function () {
                let value = $('#ipt-value').v");
                WriteLiteral(@"al();// input trong modal
